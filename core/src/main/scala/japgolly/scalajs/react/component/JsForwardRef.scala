...
object JsForwardRef {
  ...
  type Unmounted[P <: js.Object]                               = JsFn.UnmountedRoot[P]
  type Mounted                                                 = Unit
  ...
  def apply[P <: js.Object, C <: Children]
    ...
    // TODO InspectRaw.assertValidJsFn(raw, where, line)
    force[P, C](raw)(s)
  }
  ...
  def force[P <: js.Object, C <: Children](raw: js.Any)(implicit s: CtorType.Summoner[P, C]): Component[P, s.CT] = {
    ...
    componentRoot[P, s.CT, Unmounted[P]](rc, s.pf.rmap(s.summon(rc))(JsFn.unmountedRoot))(s.pf)
  }
...
//    JsFn.force[P, C](render)(s)
  ...
  /** Type used when creating a component that ignores its props */
...
//  }
  ...
  override protected def rawComponentDisplayName: RAW.React.ForwardRefComponent[_ <: js.Object] => String =
    _ => staticDisplayName
